...
declare const DirInfo: typeof fs.DirInfo;
export { fs, DirInfo, hash256, hash512, platform, osname, isLinux, isWindows, isMac, readStream, LinuxDirectoryNode, int, posint, negint, };
