...
describe("list", () => {
    describe("filterReduce", () => {
        it("should filter and reduce", () => {
            const result = (0, list_1.filterReduce)((a) => a % 2 === 0, (acc, cur) => acc + cur, 0, [1, 2, 3, 4]);
    ...
    describe("foldr", () => {
        it("should fold right", () => {
            const sum = (a, b) => a + b;
            const result = (0, list_1.foldr)(sum, 0, [1, 2, 3, 4]);
            expect(result).toBe(10);
        });
        it("should fold right and differ from fold left", () => {
            const sum = (a, b) => a + b;
            const result = (0, list_1.foldr)(sum, "0", [1, 2, 3, 4]); // 12340
            const result2 = (0, list_1.foldl)(sum, "0", [1, 2, 3, 4]); // 01234
    ...
    describe("foldl", () => {
        it("should fold left", () => {
            const sum = (a, b) => a + b;
            const result = (0, list_1.foldl)(sum, 0, [1, 2, 3, 4]);
            expect(result).toBe(10);
        });
    });
    describe("take", () => {
        it("should take", () => {
            const result = (0, list_1.take)(2, [1, 2, 3, 4]);
            expect(result).toEqual([1, 2]);
        });
    });
    describe("takeWhile", () => {
        it("should take while", () => {
            const result = (0, list_1.takeWhile)((a) => a < 3, [1, 2, 3, 4]);
            expect(result).toEqual([1, 2]);
        });
    });
    describe("head", () => {
        it("should return first 10 (default) values when n is not provided", () => {
            const input = Array(100)
                .fill(0)
                .map((_, i) => i + 1);
            const actual = (0, list_1.head)(input);
        ...
        it("should return first 5 values when n is provided as 5", () => {
            const input = Array(100)
                .fill(0)
                .map((_, i) => i + 1);
            const actual = (0, list_1.head)(input, 5);
    ...
    describe("tail", () => {
        it("should return last 10 (default) values when n is not provided", () => {
            const input = Array(100)
                .fill(0)
                .map((_, i) => i + 1);
            const actual = (0, list_1.tail)(input);
        ...
        it("should return last 5 values when n is provided as 5", () => {
            const input = Array(100)
                .fill(0)
                .map((_, i) => i + 1);
            const actual = (0, list_1.tail)(input, 5);
