...
describe("fs", () => {
    ...
    describe("readDirectorySync", () => {
        ...
        const expected = {
            error: null, content: {
                files: [".editorconfig", ".gitignore", "README.md", "coverage.txt", "index.js", "package-lock.json", "package.json",],
                directories: [".git", ".idea", ".nyc_output", "array", "coverage", "heap", "node", "node_modules", "primitives", "spec", "string", "time",],
            }
        };
